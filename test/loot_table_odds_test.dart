...
void main() {
  group('LootTableOdds', () {
    ...
    test(
        'empirical distribution matches rarityOdds within 1% after 100,000 rolls',
        () {
      final odds = kMvpLootTable.rarityOdds();
    ...
    test('invalid tables throw ArgumentError', () {
      ...
      const notInTable = LootTableEntry(
          itemId: 'b', itemName: 'B', rarity: InventoryRarity.rare, weight: 5);
